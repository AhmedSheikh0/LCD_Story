...
// PORT A Direction
#define PORTA_PIN0_DIR          STATE_OUTPUT		// RS
#define PORTA_PIN1_DIR          STATE_OUTPUT
#define PORTA_PIN2_DIR          STATE_OUTPUT		// EN
#define PORTA_PIN3_DIR          STATE_OUTPUT		// Data LCD PORT
#define PORTA_PIN4_DIR          STATE_OUTPUT        // Data LCD PORT
#define PORTA_PIN5_DIR          STATE_OUTPUT        // Data LCD PORT
#define PORTA_PIN6_DIR          STATE_OUTPUT		// Data LCD PORT
...
#define PORTB_PIN3_DIR         	STATE_INPUT
#define PORTB_PIN4_DIR         	STATE_OUTPUT
#define PORTB_PIN5_DIR         	STATE_INPUT
#define PORTB_PIN6_DIR          STATE_INPUT
#define PORTB_PIN7_DIR          STATE_OUTPUT

// PORT C Direction
#define PORTC_PIN0_DIR          STATE_INPUT
#define PORTC_PIN1_DIR          STATE_INPUT
#define PORTC_PIN2_DIR          STATE_INPUT
#define PORTC_PIN3_DIR          STATE_INPUT
#define PORTC_PIN4_DIR          STATE_INPUT
#define PORTC_PIN5_DIR          STATE_INPUT
...
#define PORTD_PIN5_DIR          STATE_INPUT
